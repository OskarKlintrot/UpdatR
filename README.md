...
Options:
  ...
  --package                                                          Package to update. Supports * as wildcard. Will update all unless specified. []
  --exclude-package                                                  Package to exclude. Supports * as wildcard. []
  --output                                                           Defaults to "output.md". Explicitly set to fileName.txt to generate plain text instead of markdown. []
  --title                                                            Outputs title to path. []
