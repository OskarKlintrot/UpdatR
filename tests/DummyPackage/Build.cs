...
app.HelpOption();
var version = app.Option<string>(
    "-v|--version <version>",
    "Version of the package.",
    CommandOptionType.SingleValue
);
var packageIdOption = app.Option<string>(
    "-id|--packageId <package-id>",
    "Name of the package.",
    CommandOptionType.SingleValue
);
var targetFrameworkOption = app.Option<string>(
    "-tfm|--target-framework <tfm>",
    "Target framework of the package.",
    CommandOptionType.SingleValue,
    conf => conf.DefaultValue = "net6.0"
);
